...
\n  }
  ...
  const step3 = ora('Step 4/7: Writing configuration...').start();
  try {
...
`;
  ...
  const step4 = ora('Step 5/7: Creating systemd service...').start();
  try {
...
`;
  ...
  const step5 = ora('Step 6/7: Setting up cron jobs...').start();
  try {
  ...
  const step6 = ora('Step 7/7: Running health checks...').start();
  try {
