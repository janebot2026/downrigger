...
**Wallet Mode:** Embedded (Cedros) — prevents private key leaks

### Wallet Safety
- **Preferred:** Embedded wallet mode via Cedros (Shamir split, server-assisted signing)
- **Local wallet:** Allowed only for dev/test
- **Goal:** Never store full private keys on disk
