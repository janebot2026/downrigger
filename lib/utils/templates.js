...
**Wallet Mode:** Embedded (Cedros)
- Private key is split using Shamir Secret Sharing (2-of-2)
- Your share is encrypted locally; Cedros holds the other share
- Transactions are signed by sending your share to Cedros (never the full key)
- This prevents key leaks from git commits or prompt injection attacks
...
- **Note:** Voice changes how I write, never what I trade. See core/VOICE.md
...
### 8. What went wrong recently
- Check: reports/incidents/YYYY-MM-DD-HHMM-<type>.md
- Answer format: "[Incident type] occurred at [time]. Impact: [description]. I [actions taken]. Recommended fix: [solution]."

### 9. Why trading is paused
- Check: state/governor.json (hard safety governor)
- Answer format: "Trading is paused because [reason]. Governor triggered at [time]. Estimated resume: [time or condition]."
...
| state/governor.json | Hard safety governor override | Why trading paused |
...
| reports/incidents/ | Auto-generated incident reports | What went wrong |
...
`,
  ...
  'AUTO_INCIDENT_TEMPLATE.md': `# Incident Autopsy: {{incidentType}}
...
| Trading stopped | {{tradingStopped}} |
| Positions affected | {{positionsAffected}} |
| Duration | {{duration}} |
...
---
*Auto-generated by bot-runner incident handler*
*Location: reports/incidents/{{filename}}*
`,

  'AUTO_INCIDENT_TEMPLATE.json': `{
  ...
  "prevention": {
    ...
    "connectivity_check_needed": false,
    "funding_check_needed": false
  },
...
`,
  ...
  'GOVERNOR_JSON': `{
  "_comment": "Hard safety governor - local kill switch that overrides everything",
  "version": 1,
  "updated_at": "{{timestamp}}",
  "global_pause": false,
  "reason": "",
  ...
  "affected_operations": {
    ...
    "swaps": false,
    "new_positions": false,
    "position_increases": false,
    "position_decreases": false,
    "all_trading": false
  },
  "triggers_that_activated": [],
  "override_conditions": {
    "can_human_override": true,
    "requires_reason": true,
    "auto_resume_conditions": {
      "time_elapsed_minutes": null,
      "error_rate_below": null,
      "rpc_stable_for_minutes": null,
      "drawdown_recovered": null
    }
  },
  "historical_activations": []
}

  'WALLET_SNAPSHOT_JSON': `{\n    "_comment": "Periodic wallet snapshot - addresses and balances only, no keys",\n    "version": 1,\n    "timestamp": "{{timestamp}}",\n    "wallet_address": "",\n    "sol_balance": 0,\n    "tokens": [],\n    "unknown_positions": [],\n    "total_value_usd": 0,\n    "snapshot_source": "bot-runner",\n    "reconciled": false,\n    "reconciliation_drifts": []\n  }`,
`,
...
module.exports = { renderTemplate, listTemplates, templates };
  ...
  'VOICE.md': `# VOICE.md - Personality Layer (Cosmetic Only)
...
`
  ...
  'CANDIDATES_PREFERENCES_JSON': `{
  "_comment": "User preference candidates from chat - require explicit confirmation to pin",
  "version": 1,
  "description": "Temporary storage for potential user preferences detected in conversation. Items here are NOT active until explicitly confirmed and moved to knowledge/pinned/CONSTITUTION.md",
  "auto_capture_enabled": true,
  "last_reviewed": null,
  "candidates": [],
  "confirmed_and_pinned": [],
  "rejected": []
}
`
