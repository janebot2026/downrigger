...
function generateTraderCronJobs(targetDir, _agentName) {
  ...
  return [
    ...
    // 2. Reconcile Backup - every 5 minutes (runner is primary, this is backup)
    {
      ...
      payload: {
        kind: 'systemEvent',
        command: `${targetDir}/scripts/reconcile_now.sh`
      }
    },
    ...
    // 4. Daily Recap - 11:55pm (systemEvent to create template + agentTurn to fill)
    // Using agentTurn at midnight for the synthesis work
    {
